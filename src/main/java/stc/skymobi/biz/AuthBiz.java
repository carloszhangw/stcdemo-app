...
public class AuthBiz {
  ...
  class ToLog {
    ...
    boolean enter(FiniteStateMachine fsm, AuthCtx ctx) {
      ...
      ctx.fireEventWithTimeout(new UUIDTimeoutEvent(req.getIdentification()), logTimeout,
          "com.skymobi.event.app.log", req);
      return true;
    }
  ...
  class ToService {
    ...
    boolean enter(FiniteStateMachine fsm, AuthCtx ctx) {
      ...
      ctx.fireEventWithTimeout(new UUIDTimeoutEvent(ctx.getRequest().getIdentification()),
          logTimeout, "event.service.req", ctx.getRequest());
      return true;
    }
